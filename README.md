...
- [ProgrammableWeb](https://www.programmableweb.com) - A good API directory.
...
-  [Have I Been Pwned?](https://haveibeenpwned.com/) - Check if an email appears in a breach, set up alerts.
-  [GhostProject](https://ghostproject.fr) - Check if an email appears in a breach. Shows the first 3 characters of the password for free.
-  [Dehashed](https://dehashed.com/) - Find cleartext & hashed password from data breaches (paid, $4/week, $11/mo).
-  [h8mail](https://github.com/khast3x/h8mail) -  Find passwords through different breach and reconnaissance services. Can also search the BreachedCompilation torrent.
- [Breach Data Search Engines Comparison](https://inteltechniques.com/blog/2018/09/30/breach-data-search-engines-comparison/) (IntelTechniques)
...
- [CompaniesHouse Short Guide](https://www.bellingcat.com/resources/how-tos/2017/06/23/companies-house-short-guide/) (Bellingcat) - A guide about the UK online company registry.
...
- [netbootcamp](https://netbootcamp.org/osinttools/) - Custom search forms and lists of resources by theme.
...
- [Shadows and Angles: Measuring Object Heights from Satellite Imagery](https://www.gislounge.com/shadows-angles-measuring-object-heights-satellite-imagery/) (GISLounge)
- [SunCalc](https://suncalc.org/) - Historical solar data (sun orientation & elevation, shadow length, etc).

### User generated content
- Social media ([see category](#social-media))
- Tourism & review websites: [Foursquare](https://foursquare.com/), [TripAdvisor](https://www.tripadvisor.com/), [Yelp](https://www.yelp.com/)...
...
- [EchoSec](https://www.echosec.net/) - Search and analyze social media data based on location. ($499/mo)
...
- [Maltego CE](https://www.paterva.com/web7/buy/maltego-clients/maltego-ce.php) - Interactive data mining & mapping tool.
- [DataSploit](https://github.com/DataSploit/datasploit) - A collection of python scripts which automate open source intelligence searches about domain names, email addresses, IP addresses and usernames.
...
- [Spiderfoot](http://www.spiderfoot.net/) - Open source intelligence automation tool. Gathers intelligence about a given target, which may be an IP address, domain name, hostname, network subnet, ASN, e-mail address or person's name.

## Phone numbers
- [NumberWay](https://www.numberway.com/) - International directory of white pages and yellow pages phone books.
...
- [Youtube Geo Search Tool]( https://youtube.github.io/geo-search-tool/search.html) - Search YT videos by location & time frame.
- [IntelTechniques.com](https://inteltechniques.com/menu.html) - Various video search & reverse search tools and lists of resources.
...
### Reverse search
- [IntelTechniques.com](https://inteltechniques.com/menu.html)- Various image search & reverse search tools and lists of resources.
...
- [InVID Verification Plugin](https://www.invid-project.eu/tools-and-services/invid-verification-plugin/) - Verification “Swiss army knife” Firefox extension.
- [Photo Verification Cheatsheet](https://firstdraftnews.org/wp-content/uploads/2017/03/FDN_verificationguide_photos.pdf) & [Video Verification Cheatsheet](https://firstdraftnews.org/wp-content/uploads/2017/03/FDN_verificationguide_videos.pdf) (FirstDraftNews)
...
- [Immaga](https://imagga.com/auto-tagging-demo) - Pictures auto-tagging tool (Demos + Free API Plan 2000 images/mo, or 14$/mo)
- [CalibreObscura](https://www.calibreobscura.com/) - A blog about weapons & their uses in Middle East conflicts.
...
### Facebook
- [Scrape Facebook with your browser](https://docs.google.com/presentation/d/15Uyk90ApliDE4AloCaNfDwSRDwp7b6QYAq0pfoVeQvQ/edit#slide=id.g1ba6b7ca38_0_226) (J++)
...
### Linkedin
- [raven](https://github.com/0x09AL/raven) - Linkedin information gathering tool. Extracts employee data for a given company.

### Reddit
- [Reddit Investigator](http://www.redditinvestigator.com/) - Collect info on a Reddit profile.
- [Reddit Insight](https://www.redditinsight.com/#trackuser) - Collect info on a Reddit profile, list all posts & comments.
...
- [tinfoleak](https://github.com/vaaguileradiaz/tinfoleak) - Very complete open-source tool for Twitter intelligence analysis. Needs API credentials.
...
### OCR
- [NewOCR.com](https://www.newocr.com/) - Recognizes several languages, can resize images, shortcuts to Google & Bing Translate.
...
- [Visual Investigative Scenarios](https://vis.occrp.org/) (OCCRP)
...
- Whois - Get registrar, owner info.
...
### Scraping
- Python scraping libraries: [BeautifulSoup](https://www.crummy.com/software/BeautifulSoup/bs4/doc/), [Selenium](https://www.seleniumhq.org/), [Scrapy](https://scrapy.org/)
- [Photon](https://github.com/s0md3v/Photon) - Crawl a website (or its archive from the WayBack machine) and extract URLs, emails, social media accounts, files, keys, subdomains, etc.
